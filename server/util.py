...
def get_cropped_image_if_2_eyes(image_path, image_base64_data):
    face_cascade = cv2.CascadeClassifier('/Users/abhilekhyadav/Desktop/Sports_Person/server/opencv/haarcascades/haarcascade_frontalface_default.xml')
    eye_cascade = cv2.CascadeClassifier('/Users/abhilekhyadav/Desktop/Sports_Person/server/opencv/haarcascades/haarcascade_eye.xml')
...
if __name__ == '__main__':
    ...
    #print(classify_image(get_b64_test_image_for_sharapova1(), None))
